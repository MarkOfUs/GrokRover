...
## Showcase: jezero-delta-real

A second real world, seeded at the delta front — input data, Grok Imagine
canvas, and the resulting scene:

![delta-real seed](docs/img/jezero-delta-real-seed.png)

![delta-real canvas](docs/img/jezero-delta-real-canvas.png)

![delta-real hero](docs/img/jezero-delta-real-hero.png)

![delta-real overhead](docs/img/jezero-delta-real-overhead.png)
